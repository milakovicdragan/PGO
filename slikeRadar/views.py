...
from slikeRadar.filters import SlikeFilter
...
#
# '''Kreiram metod za paggination na osnovu kojeg ce da vrati json podatak
# ovaj metod receive request'''
# def listing_api(request):
#     page_number = request.GET.get("page", 1)
#     per_page = request.GET.get("per_page", 1)
#     startwith = request.GET.get("startswith", "")
#     # keywords = Slike.objects.filter(title__startswith=startwith)
#     keywords = Slike.objects.filter(title__startswith=startwith)
#     paginator = Paginator(keywords, per_page)
#     page_obj = paginator.get_page(page_number)
#     data = [{'name': kw.title} for kw in page_obj.object_list]
#
#     payload = {
#         "page": {
...
#     keywords = Slike.objects.all().order_by("title")
#     paginator = Paginator(keywords, per_page=2)
#     page_object = paginator.get_page(page)
#     context = {"page_obj": page_object}
#     return render(request, "slikeRadar/keyword.html", context)
